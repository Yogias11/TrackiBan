...
<div class="row">
    <div class="col-md-6">
        <form action="{{ route('track.update', $track->id) }}" class="form-horizontal" method="POST">
            @csrf
            @method('PUT')
            <section class="panel">
                ...
                <div class="panel-body">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-9">
                            <input type="text" name="jarak" class="form-control" placeholder="eg.: 1000" required value="{{ $track->jarak }}"/>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-9">
                            <input type="text" name="kontainer" class="form-control" placeholder="eg.: John Doe" required value="{{ $track->kontainer }}"/>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-9">
                            <input type="text" name="posisi" class="form-control" placeholder="eg.: John Doe" required value="{{ $track->posisi }}"/>

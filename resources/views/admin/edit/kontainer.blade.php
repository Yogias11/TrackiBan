...
<div class="row">
    <div class="col-md-6">
        <form action="{{ route('kontainer.update', $track->id) }}" class="form-horizontal" method="POST">
            @csrf
            <section class="panel">
                ...
                <div class="panel-body">
                    ...
                    <div class="form-group">
                        <label class="col-sm-3 control-label">Posisi Kontainer <span class="required">*</span></label>
                        <div class="col-sm-9">
